module Inkcite
  class Renderer::Link < Renderer::Base
    ...
    def render tag, opt, ctx
      ...
      if mobile
        ...
        if mobile == BUTTON
          ...
          att[:class] = BUTTON
          ctx.responsive_styles << css_rule('a', Responsive::BUTTON, 'display: block; padding: 8px; text-align: center !important; border-radius: 4px; background-color: rgba(0,0,0,0.33); text-shadow: 0 -1px 0 #009 !important;')
    ...
    # Global property for link colors
    LINK_COLOR = '#link'
